...
exit_with_message (char *reason, char *argv0)
{
	...
	if (answer == NSAlertFirstButtonReturn) {
		NSString *mono_download_url = @"https://www.mono-project.com/download/";
...
int main (int argc, char **argv)
{
	...
	NSString *binDir = [[NSString alloc] initWithUTF8String: "MonoBundle"];
	...
	NSString *appDir = [[self stringByDeletingLastPathComponent] stringByDeletingLastPathComponent];
	//printf ("%s\n", [appDir UTF8String]);
