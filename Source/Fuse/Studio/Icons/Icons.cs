	...
	public static class Icons
	{
		...
		static IControl FromResource(string resourceName, Brush overlayColor = default(Brush), IObservable<IColorMap> colorMap = null)
		{
			...
			return overlayColor.IsDefault 
				? Fusion.Image.FromResource(resourceName, typeof(Icons).Assembly, colorMap: colorMap) 
				: Fusion.Image.FromResource(resourceName, typeof(Icons).Assembly, overlayColor, colorMap);
		}
