...
namespace Outracks.Fuse.Theming.Themes
{
	internal class OriginalLightTheme : ITheme
	{
		...
		{
			get { return Color.FromRgb(0x5DABBC); }
		}
		...
		static readonly IObservable<IColorMap> _colorMap = Observable.Return(new NoopColorMap());

		public IObservable<IColorMap> IconColorMap { get { return _colorMap; } }
	}
}