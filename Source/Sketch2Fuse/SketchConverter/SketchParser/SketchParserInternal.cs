...
namespace SketchConverter.SketchParser
{
	...
	internal static class Extensions
	{
		...
		public static async Task<string> ReadToStringAsync(this Stream stream, System.Text.Encoding encoding = null)
		{
			using (var text = new StreamReader(stream, encoding ?? System.Text.Encoding.UTF8))
			{
