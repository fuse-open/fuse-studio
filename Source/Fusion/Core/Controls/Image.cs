...
namespace Outracks.Fusion
{
	public static class Image
	{
		...
		public static IControl FromImage(IObservable<IImage> image, IObservable<IColorMap> colormMap = null, IObservable<Ratio<Pixels, Points>> dpiOverride = null)
		{
			return Implementation.Factory(
				image,
				Optional.None(),
				colormMap.ToOptional(),
