...
namespace Outracks.Fusion
{
	public static class Collapsable
	{
		...
		{
			return self.ShowWhen(Observable.Return(Platform.OperatingSystem == OS.Windows));
		}

		public static IControl ShowOnMac(this IControl self)
		{
			return self.ShowWhen(Observable.Return(Platform.OperatingSystem == OS.Mac));
		}
		...
		{
			return self.HideWhen(Observable.Return(Platform.OperatingSystem == OS.Windows));
		}

		public static IControl HideOnMac(this IControl self)
		{
			return self.HideWhen(Observable.Return(Platform.OperatingSystem == OS.Mac));
		}
