...
namespace Outracks.Fusion.Windows
{
	...
	public static class Marshalling
	{
		...
		public static Transform ToWpfScaleRotation(this Outracks.Matrix matrix)
		{
		...
		*/
		...
		public static Color ToColor(this Fusion.Color value)
		{
			return new Color()
			{
				R = (byte) (value.R * 255),
		...
		public static Fusion.Color ToFusion(this Color value)
		{
			return Fusion.Color.FromBytes(
				r: value.R,
				g: value.G,
				b: value.B,
				a: value.A);
